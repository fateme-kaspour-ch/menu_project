        ...
        try:
            while True:
                ...
                if name == 'circle':
                    ...
                    s = p * r * r
                    a = p * r * 2
                    print('The area of circle is equal to : {} and The circumference of circle is equal to : {}'.format(s,a))
                    break
                    ...
                    s = z_s ** 2
                    a = z_s * 4
                    print('The area of square is equal to : {} and The circumference of the square is equal to : {}'.format(s,a))
                    break
                    ...
                    s = l * w
                    a = (l + w) * 2
                    print('The area of the rectangle is : {} and The circumference of the rectangle is : {}'.format(s,a))
                    break
                else:
...
while True:
    ...
    if selection == "1":
        ...
        print("Please enter a True number between 1 to 7 ")
